            ...
            <section id="passiv">
                ...
                <div class="rules-grid">
                    <div class="rule-card searchable" onclick="copyCardText(this)">
                        <div class="card-title">ПД Фишинг и ТКО</div>
...
ИСКЛЮЧЕНИЕ: нельзя использовать стилю крюк слоу клики после ультимейта. После ультимейта айрон фиста можно делать ДВА КОМБО СЛОУ КЛИКА.</div>
            ...
            <section id="movement">
                ...
                <div class="rules-grid">
                    <div class="rule-card searchable" onclick="copyCardText(this)">
                        <div class="card-title">С-кейтинг, дистанция и деши</div>
...
• Пользовательские звуковые эффекты и изображения ультимативных способностей (ульта) разрешены.</div>
            ...
            <section id="title-fights">
                ...
                <div class="rules-grid">
                    <div class="rule-card searchable" onclick="copyCardText(this)">
                        <div class="card-title">Правила титульных боев</div>
...
ЗАЩИТА ТИТУЛА ЧЕМПИОНА UCL: КАЖДЫЕ 2.5 НЕДЕЛИ</div>
            ...
            <section id="general-rules">
                ...
                <div class="rules-grid">
                    <div class="rule-card searchable" onclick="copyCardText(this)">
                        <div class="card-title">Регламент арены и вызовы</div>
                        <div class="card-desc">Проблемы со связью и вылеты: Если прямо посреди матча у вас оборвалось соединение или вылетела игра, включается счетчик: у вас есть ровно 5 минут на немедленное возвращение. Если не уложитесь в этот дедлайн - поединок либо полностью аннулируется, либо вам присуждается технический нокаут (ТКО) по решению рефери.
Неоспоримый авторитет рефери: Вердикт судьи на ринге - это закон, который не обсуждается во время боя. Однако, если рефери допустил явную и грубую ошибку, это не сойдет ему с рук - после проверки такое судейство будет жестко караться.
Суточный лимит на поединки: Не стоит перегорать на ринге. Введено строгое ограничение: один боец имеет право провести не более 3 боев за одни сутки.
Смена дивизионов и путевка наверх: Если вы аннигилируете соперников без шансов, администрация может принудительно перевести вас выше. В обычном порядке нужно сначала завоевать чемпионский пояс текущего рейтинга и провести как минимум одну успешную защиту.
Право на вызов чемпиона: Бросить вызов действующему чемпиону могут только бойцы из первой пятерки (Топ-5) рейтинга. При этом первый номер таблицы (Топ-1) обладает эксклюзивной привилегией: чемпион обязан принять его вызов безоговорочно!</div>
                    </div>
                </div>
            </section>
